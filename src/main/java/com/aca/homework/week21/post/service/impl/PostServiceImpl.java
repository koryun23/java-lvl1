...
public class PostServiceImpl implements PostService {
    ...
    public Optional<Post> findPostById(Long id) {
        ...
        LOGGER.info("Retrieving an optional of a post with an id of {}", id);
        Optional<Post> postOptional = postRepository.findById(id);
        LOGGER.info("Successfully retrieved an optional of a post with an id of {}, result - {}", id, postOptional);
        return postOptional;
    }
}
